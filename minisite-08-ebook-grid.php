                ...
                <div class="swiper-wrapper">
                  <?php foreach($content as $d){?>
                    <div class="swiper-slide">
                      <a class="ss-card ss-card-83" href="#">
                        <div class="wrapper">
                      ...
                      <div class="swiper-slide">
                        <div class="grids">
                          <div class="grid xl-50 lg-50 md-100 sm-100" data-aos="fade-up" data-aos-delay="150">
                            <a class="ss-card ss-card-82 card-main" href="#">
                              <div class="wrapper">
                                <div class="img-container">
                                  <div class="ebook-container">
                                    <div class="wrapper">
                                      <img src="<?php echo $content['0']['image'] ?>" alt="Ebook">
                                        <div class="shadow-container">
                                          <img class="img" src="public/assets/app/images/content/shadow.png" alt="Shadow">  
                                      </div>
                                    </div>
                                  ...
                                  <div class="filter style-05 op-1"></div>
                                </div>
                              </div>
                          ...
                          <div class="grid xl-50 lg-50 sm-100 md-100" data-aos="fade-up" data-aos-delay="150">
                            <div class="grids">
                              <div class="grid lg-50 mt-0">
                                <a class="ss-card ss-card-82 card-sub style-02" href="#">
                                  <div class="wrapper">
                                    <div class="img-container">
                                      <div class="ebook-container">
                                        <div class="wrapper">
                                          <img src="public/assets/app/images/content/48.jpg" alt="Ebook">
                                            <div class="shadow-container">
                                              <img class="img" src="public/assets/app/images/content/shadow.png" alt="Shadow">  
                                          </div>
                                        </div>
                              ...
                              <a class="ss-card ss-card-82 card-sub style-02" href="#">
                                <div class="wrapper">
                                  <div class="img-container">
                                    <div class="ebook-container">
                                      <div class="wrapper">
                                        <img src="public/assets/app/images/content/53.jpg" alt="Ebook">
                                          <div class="shadow-container">
                                            <img class="img" src="public/assets/app/images/content/shadow.png" alt="Shadow">  
                                        </div>
                                      </div>
                                ...
                                <a class="ss-card ss-card-82 card-sub style-02" href="#">
                                  <div class="wrapper">
                                    <div class="img-container">
                                      <div class="ebook-container">
                                        <div class="wrapper">
                                          <img src="public/assets/app/images/content/54.jpg" alt="Ebook">
                                            <div class="shadow-container">
                                              <img class="img" src="public/assets/app/images/content/shadow.png" alt="Shadow">  
                                          </div>
                                        </div>
                                ...
                                <a class="ss-card ss-card-82 card-sub style-02" href="#">
                                  <div class="wrapper">
                                    <div class="img-container">
                                      <div class="ebook-container">
                                        <div class="wrapper">
                                          <img src="public/assets/app/images/content/50.jpg" alt="Ebook">
                                            <div class="shadow-container">
                                              <img class="img" src="public/assets/app/images/content/shadow.png" alt="Shadow">  
                                          </div>
                                        </div>
