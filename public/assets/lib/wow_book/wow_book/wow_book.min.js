...
jQuery.extend(jQuery.easing, {
  easeOutCubic: function (e, p, w, u, r) {
    return u * ((p = p / r - 1) * p * p + 1) + w;
  },
  easeOutExpo: function (e, p, w, u, r) {
    return p == r ? w + u : u * (-Math.pow(2, (-10 * p) / r) + 1) + w;
  },
});
window.Modernizr = (function (e, p, w) {
  function u(a, b) {
    for (var c in a) if (B[a[c]] !== w) return "pfx" == b ? a[c] : !0;
    return !1;
  }
  function r(a, b, c) {
    var d = a.charAt(0).toUpperCase() + a.substr(1),
      e = (a + " " + C.join(d + " ") + d).split(" ");
    if ("string" === typeof b || "undefined" === typeof b) b = u(e, b);
    else
      a: {
  ...
  var F = [],
    ...
    c = function (a, b, c, d) {
      var e,
        ...
        h = p.body,
        k = h ? h : p.createElement("body");
      if (parseInt(c, 10))
        for (; c--; ) {
          var l = p.createElement("div");
          l.id = d ? d[c] : "modernizr" + (c + 1);
          g.appendChild(l);
        }
      return (
        (e = ["&#173;<style>", a, "</style>"].join("")),
        (g.id = "modernizr"),
        ((h ? g : k).innerHTML += e),
        k.appendChild(g),
        h || ((k.style.background = ""), z.appendChild(k)),
        (f = b(g, a)),
        h ? g.parentNode.removeChild(g) : k.parentNode.removeChild(k),
        !!f
      );
    },
    d = {}.hasOwnProperty,
      ...
      var d = a.call(arguments, 1),
        e = function () {
          if (this instanceof e) {
            ...
            f = new f();
            var g = c.apply(f, d.concat(a.call(arguments)));
  ...
  n.csstransforms3d = function () {
    var a = !!r("perspective");
    return a && "webkitPerspective" in z.style && (a = m.csstransforms3d), a;
  };
  for (var g in n)
    f(n, g) &&
      ((b = g.toLowerCase()), (m[b] = n[g]()), F.push((m[b] ? "" : "no-") + b));
  B.cssText = "";
  return (
    (n = null),
    (m._version = "2.5.3"),
  ...
  var B = (function () {
    function m() {
      var b = u(),
        g = d(a);
      b !== a
        ? (c((a = b), g), e(p).trigger("hashchange"))
        : g !== a && (location.href = location.href.replace(/#.*/, "") + g);
      B = setTimeout(m, e.fn.hashchange.delay);
    }
    var z = {},
      B,
      a = u(),
        ...
        z.start = function () {
          a ||
            ...
            (r.onpropertychange = function () {
              try {
                "title" === event.propertyName && (a.document.title = r.title);
              } catch (h) {}
            }));
        };
        z.stop = b;
...
try {
  (function (e, p, w, u) {
    ...
    function C(a, b, c) {
      b = b.prototype;
      var d = (a.prototype = Object.create(b));
      d.constructor = a;
      d._super = b;
      c && n(d, c);
    }
    ...
    function F(a, b) {
      return "function" == typeof a ? a.apply(b ? b[0] || u : u, b) : a;
    }
    function a(a, b, c) {
      z(d(b), function (b) {
    ...
    function t(a) {
      ...
      return new (b ? b : ra ? S : sa ? L : ha ? T : M)(a, q);
    }
    function q(a, b, d) {
      ...
      1 < g && !b.firstMultiple
        ? (b.firstMultiple = ca(d))
        : 1 === g && (b.firstMultiple = !1);
      f = b.firstInput;
      ...
      h = b.prevDelta || {};
      var k = b.prevInput || {};
      if (1 === d.eventType || 4 === k.eventType)
        (h = b.prevDelta = { x: k.deltaX || 0, y: k.deltaY || 0 }),
      ...
      g
        ? ((f = g.pointers), (f = K(e[0], e[1], N) / K(f[0], f[1], N)))
        : (f = 1);
      d.scale = f;
      g
        ? ((g = g.pointers), (e = V(e[1], e[0], N) + V(g[1], g[0], N)))
        : (e = 0);
      d.rotation = e;
      d.maxPointers = b.prevInput
        ? d.pointers.length > b.prevInput.maxPointers
          ? d.pointers.length
          : b.prevInput.maxPointers
        : d.pointers.length;
      A = b.lastInterval || d;
      e = d.timeStamp - A.timeStamp;
      8 != d.eventType && (25 < e || A.velocity === u)
        ? ((f = d.deltaX - A.deltaX),
          (A = d.deltaY - A.deltaY),
          (h = f / e || 0),
          (k = A / e || 0),
    ...
    function wa(a, b) {
      ...
      for (d = 0; d < f.length; )
        e[f[d].identifier] && A.push(f[d]),
          b & 12 && delete e[f[d].identifier],
          d++;
    ...
    function H(a, b) {
      b = b || {};
      var c = b.recognizers;
      b.recognizers = c === u ? H.defaults.preset : c;
      return new ba(a, b);
    }
    function ba(a, b) {
      b = b || {};
    ...
    function oa(a, b) {
      var c = a.element;
      c.style &&
        z(a.options.cssProps, function (a, d) {
    ...
    var fa = " webkit moz MS ms o".split(" "),
      Aa = p.createElement("div"),
      J = Math.round,
      I = Math.abs,
      U = Date.now,
      ya = 1,
      Ba = /mobile|tablet|ip(ad|hone|od)|android/i,
      ha = "ontouchstart" in e,
      ra = k(e, "PointerEvent") !== u,
      sa = ha && Ba.test(navigator.userAgent),
      ia = ["x", "y"],
      N = ["clientX", "clientY"];
    v.prototype = {
      handler: function () {},
      init: function () {
        ...
        this.evWin && a(l(this.element), this.evWin, this.domHandler);
      },
      destroy: function () {
    ...
    var Ca = { mousedown: 1, mousemove: 2, mouseup: 4 },
      ta = "mousedown",
    ...
    var Da = {
      ...
      Ea = { 2: "touch", 3: "pen", 4: "mouse", 5: "kinect" },
      ja = "pointerdown",
      ka = "pointermove pointerup pointercancel";
    e.MSPointerEvent &&
      ((ja = "MSPointerDown"),
      (ka = "MSPointerMove MSPointerUp MSPointerCancel"));
    C(S, v, {
      handler: function (a) {
        var b = this.store,
          c = !1,
        ...
        d = Da[d];
        var e = Ea[a.pointerType] || a.pointerType,
          g = "touch" == e,
    ...
    var Fa = { touchstart: 1, touchmove: 2, touchend: 4, touchcancel: 8 };
    C(la, v, {
      handler: function (a) {
        var b = Fa[a.type];
        1 === b && (this.started = !0);
    ...
    var Ga = { touchstart: 1, touchmove: 2, touchend: 4, touchcancel: 8 },
    ...
    W.prototype = {
      set: function (a) {
        ...
        qa &&
          ...
          (this.manager.element.style[pa] = a);
    ...
    G.prototype = {
      ...
      requireFailure: function (a) {
        ...
        a = O(a, this);
        -1 === f(b, a) && (b.push(a), a.requireFailure(this));
        return this;
      },
      dropRequireFailure: function (a) {
        if (m(a, "dropRequireFailure", this)) return this;
        a = O(a, this);
        a = f(this.requireFail, a);
      ...
      recognize: function (a) {
        a = n({}, a);
        F(this.options.enable, [this, a])
          ? (this.state & 56 && (this.state = 1),
            (this.state = this.process(a)),
            this.state & 30 && this.tryEmit(a))
    ...
    C(P, E, {
      ...
      attrTest: function (a) {
        return (
          E.prototype.attrTest.call(this, a) &&
          (this.state & 2 || (!(this.state & 2) && this.directionTest(a)))
        );
      },
      emit: function (a) {
        this.pX = a.deltaX;
        this.pY = a.deltaY;
        var b = na(a.direction);
    ...
    C(X, E, {
      ...
      attrTest: function (a) {
        return (
          ...
          (Math.abs(a.scale - 1) > this.options.threshold || this.state & 2)
        );
      },
      emit: function (a) {
        1 !== a.scale &&
          (a.additionalEvent =
            this.options.event + (1 > a.scale ? "in" : "out"));
        this._super.emit.call(this, a);
      },
    });
    C(Y, G, {
    ...
    C(Z, E, {
      ...
      attrTest: function (a) {
        return (
          this._super.attrTest.call(this, a) &&
          (Math.abs(a.rotation) > this.options.threshold || this.state & 2)
        );
      },
    });
    C(aa, E, {
      ...
      attrTest: function (a) {
        ...
        if (b & 30) var c = a.overallVelocity;
          ...
          b & 6 ? (c = a.overallVelocityX) : b & 24 && (c = a.overallVelocityY);
        return (
          this._super.attrTest.call(this, a) &&
          b & a.offsetDirection &&
    ...
    ba.prototype = {
      ...
      recognize: function (a) {
        ...
        if (!b.stopped) {
          ...
          for (var e = 0; e < c.length; ) {
            var f = c[e];
            2 === b.stopped || (d && f != d && !f.canRecognizeWith(d))
              ? f.reset()
              : f.recognize(a);
      ...
      off: function (a, b) {
        var c = this.handlers;
        z(d(a), function (a) {
          b ? c[a].splice(f(c[a], b), 1) : delete c[a];
        });
        return this;
      },
      emit: function (a, b) {
        this.options.domEvents && za(a, b);
...
(function (e) {
  function p(a, b) {
    ...
    f =
      this.pagesContainer =
      this.origin =
        e("<div class='wowbook-origin'></div>")
          .css({ position: "absolute" })
          .appendTo(a);
    c.bookShadow = e("<div class='wowbook-book-shadow'></div>")
      .appendTo(a)
    ...
    c.shadowClipper = e(".wowbook-shadow-clipper", f).css({ display: "none" });
    c.foldShadow = e("<div class='wowbook-shadow-fold'></div>").appendTo(
      c.shadowContainer
    );
    c.foldGradientContainer = e(
      "<div class='wowbook-fold-gradient-container'></div>"
    ).appendTo(c.shadowContainer);
    c.foldGradientElem = e(
      "<div class='wowbook-fold-gradient'></div>"
    ).appendTo(c.foldGradientContainer);
    c.hardPageDropShadow = e("<div class='wowbook-hard-page-dropshadow'></div>")
      .css({ display: "none" })
      .appendTo(f);
    !e.support.opacity &&
      e.wowBook.support.filters &&
      e.wowBook.applyAlphaImageLoader([
    ...
    this.leftHandle = e("<div class='wowbook-handle wowbook-left'></div>")
      .data("corner", "l")
      .appendTo(f);
    this.rightHandle = e("<div class='wowbook-handle wowbook-right'></div>")
      .data("corner", "r")
      .appendTo(f);
    Modernizr.csstransforms3d &&
      ((d = e("<div>").css("transform", "perspective(1px)")),
      (this.perspectiveUnit = "none" != d.css("transform") ? "px" : ""),
      (d = null));
    e.browser.msie &&
      e(".wowbook-handle", a).css({ backgroundColor: "#fff", opacity: "0.01" });
    e(".wowbook-handle", f).bind("mousedown.wowbook", function (a) {
      return c.pageEdgeDragStart(a);
    });
    b.curl &&
      e(".wowbook-handle", f).hover(
        function (a) {
          c.curlTimer ||
            (c.curlTimer = setTimeout(function () {
              var b =
                a.target == c.leftHandle[0] ? c.leftPage() : c.rightPage();
              if (b) {
                var d = b.offset();
                c.curl(
                  b,
    ...
    e(".wowbook-handle", f)
      ...
      .on("mouseup.wowbook", function () {
        ...
        if (
          !(new Date().getTime() - g > c.opts.handleClickDuration || a != h)
        ) {
    ...
    Modernizr.csstransforms3d &&
      ...
      (e.wowBook.useTranslate3d =
        1 == f || ("mobile" == f && e.wowBook.utils.isMobile()));
    b.useScale3d = b.useScale3d && Modernizr.csstransforms3d;
    if (b.deepLinking && this.getLocationHash()) {
      try {
        var l = c.selectorToPage("#" + this.getLocationHash());
      } catch (v) {}
      void 0 === l && (l = c.locationHashToPage());
      "number" === typeof l &&
        ((c.startPage = l),
        b.moveToViewPort && !u(c.elem) && c.elem[0].scrollIntoView());
    }
    this.flipSound && (this.audio = this.createAudioPlayer());
    this.opts.keyboardNavigation &&
      ((l = e.wowBook.defaults.keyboardNavigation),
      this.rtl &&
        this.opts.keyboardNavigation == l &&
        (this.opts.keyboardNavigation = { back: l.advance, advance: l.back }),
      e(document).on("keydown.wowbook", function (a) {
        e(a.target).filter("input, textarea, select").length ||
          c.holdedPage ||
          (c.opts.lightbox && !c.lightboxOn) ||
          (a.which === c.opts.keyboardNavigation.back && c.back(),
          a.which === c.opts.keyboardNavigation.advance && c.advance());
      }));
    e(window).on("hashchange.wowbook", function () {
      var a = window.location.hash;
      if (a === c.locationHashSetTo) c.locationHashSetTo = void 0;
      else {
        var d = (a = "" === a && !c.locationEndsInHash())
          ? c.startPage
          : c.locationHashToPage();
        "number" === typeof d &&
          (c.gotoPage(d, !a),
          a || !b.moveToViewPort || u(c.elem) || c.elem[0].scrollIntoView());
      }
    });
    b.forceBasicPage &&
    ...
    this.mouseWheel &&
      ("zoom" == c.mouseWheel &&
        a.bind("mousemove.wowbook mouseenter.wowbook", function (a) {
          c._mousemoveEvent = a;
        }),
    ...
    if (!e.wowBook.support.boxSizing) {
      ...
      f =
        "none" == a.css("borderTopStyle")
          ? 0
          : z[(g = a.css("borderTopWidth"))] || parseFloat(g);
      d =
        "none" == a.css("borderRightStyle")
          ? 0
          : z[(g = a.css("borderRightWidth"))] || parseFloat(g);
      var h =
        "none" == a.css("borderBottomStyle")
          ? 0
          : z[(g = a.css("borderBottomWidth"))] || parseFloat(g);
      var k =
        "none" == a.css("borderLeftStyle")
          ? 0
          : z[(g = a.css("borderLeftWidth"))] || parseFloat(g);
      d =
  ...
  p.prototype = {
    ...
    setDimensions: function (a, b) {
      ...
      var f = c.parent(),
        g = f.css("display");
      0 <= g.indexOf("flex") && f.css("display", "block");
      var h = c.height();
      ...
      0 <= g.indexOf("flex") && f.css("display", g);
      f = this.origin.css({ width: "100%", height: h });
      d &&
        this.centeredWhenClosed &&
        ((g = parseFloat(f.css("left"), 10)),
        f.css("left", g / (d / this.pageWidth)));
      ...
      this.opts.handleWidth &&
        e(".wowbook-handle", f).css("width", this.opts.handleWidth);
    ...
    setPagesDimension: function () {
      for (var a, b, c, d = 0, f = this.pages.length; d < f; d++)
        (page = this.pages[d]),
          (b = page.isCover
            ? this.pageWidth
          ...
          (a = e(".wowbook-page-content", page)),
          r(a, b, c),
          this.setPageCorners(page);
      this.opts.gutterShadow &&
        e(".wowbook-gutter-shadow", this.elem).css("height", c);
    },
    ...
    insertPage: function (a, b) {
      if (this.isDoublePage(a)) this.insertDoublePage(a, b);
        ...
        var c = e("<div class='wowbook-page'></div>")
          .css({
            width: this.pageWidth,
            height: this.pageHeight,
            display: "none",
          ...
          .append(a);
        e.wowBook.support.boxSizing &&
          a.css(e.wowBook.support.boxSizing, "border-box");
        r(a, this.pageWidth, this.pageHeight);
    ...
    insertDoublePage: function (a, b) {
      if (!this._insertingDoublePage) {
        ...
        c.css("left", 0);
        d.css("right", "100%");
        f.css({ width: "200%", height: "100%", position: "relative" });
        f.css(e.wowBook.support.boxSizing + "", "border-box").wrap(
        ...
        g && (g.otherHalf = f);
        e.wowBook.support.boxSizing ||
          (r(c, 2 * this.pageWidth, this.pageHeight),
          r(d, 2 * this.pageWidth, this.pageHeight));
        b || this.updateBook();
    ...
    selectPagesToUnload: function (a) {
      ...
      g = g && g.pageIndex;
      h = h && h.pageIndex;
      for (var k = 0, l = this.pages.length; k < l; k++) {
        var v = this.pages[k];
        v.loaded &&
          k != c &&
          k != a &&
    ...
    updateBook: function (a) {
      ...
      for (var d = 0, f = this.pages.length - 1; d <= f; d++) {
        var g = this.pages[d]
        ...
        g.isCover =
          ...
          (0 == d ||
            d == f ||
            (this.closable && 1 == d) ||
            (d == f - 1 && !this.otherPage(f)));
        var h = e(".wowbook-page-content", g);
        g.src = this.replaceNumberHolder(h.data("src") || this.opts.srcs, d);
        g.image = this.replaceNumberHolder(
          h.data("image") || this.opts.images,
          d
        );
      ...
      function a(a) {
        if (0 == a || a == b) {
          ...
          if (d) {
            var e = c.backPage(a);
            c.otherPage(a)
              ? e || ((d.cover = !1), (d.insideCover = !0))
              : ((d.cover = !0),
                (d.insideCover = !1),
                e && !e.cover && (e.insideCover = !0));
          }
        }
      }
    ...
    doPageNumbering: function () {
      ...
      if (a.pageNumbers && this.pages.length) {
        ...
        var f = this.opts.firstPageNumber;
        for (c = 0; c < a; c++) delete this.pages[c].number;
        for (c = 0; c < d; c++)
          e(".wowbook-page-number", this.pages[c]).remove();
        for (c = b + 1; c < a; c++)
          e(".wowbook-page-number", this.pages[c]).remove();
        for (c = d; c <= b; c++)
          (this.pages[c].number = f),
            (a = e(".wowbook-page-number", this.pages[c])),
            a.length ||
              ((a = e(".wowbook-page-content", this.pages[c])),
              (a = e('<div class="wowbook-page-number"></div>').appendTo(a))),
            a.html(f++);
      }
    },
    upsertNumberInPage: function (a) {
      ...
      if (a.number || 0 === a.number) {
        ...
        b.length ||
          ((content = e(".wowbook-page-content", a)),
          (b = e('<div class="wowbook-page-number"></div>').appendTo(content)));
        b.html(a.number);
      }
    },
    upsertGutterShadowInPage: function (a) {
      ...
      a.find(".wowbook-gutter-shadow").length ||
        ...
        e("<div class='wowbook-gutter-shadow'>")
    ...
    showPage: function (a, b) {
      ...
      this.differentPageSizes &&
        (null !== f && this.loadPage(this.insideCoverLeft),
        null !== g && this.loadPage(this.insideCoverRight));
      this.opts.pagesInMemory && this.unloadUnusedPages(a);
      for (var l = 0; l <= k; l++) {
        var v = this.pages[l].onLeft != this.rtl ? l : k - l;
        var t = l === f || l === c || l === d || l === g ? "block" : "none";
        this.pages[l]
          .data("zIndex", v)
          .css({
            display: t,
            left: this.pages[l].onLeft ? 0 : h,
            top: 0,
            zIndex: v,
          });
        this.setPagePosition(this.pages[l]);
      }
      this.differentPageSizes &&
        (null !== f && this.insideCoverLeft.css("display", "block"),
      ...
      c = !this.pages.length;
      this.toggleControl("left", c || (this.rtl ? k : f));
      this.toggleControl("lastLeft", c || (this.rtl ? k : f));
      this.toggleControl("right", c || (this.rtl ? f : k));
      this.toggleControl("lastRight", c || (this.rtl ? f : k));
      (c = this.onShowPage) &&
        e.isFunction(c) &&
        !this.isOnPage(a) &&
        ((this.currentPage = a),
      ...
      this._sliding ||
        ((c = this._singlePage && this.pageIsOnTheRight(a) ? -h : 0),
      ...
      this.centeredWhenClosed &&
        ...
        ((c = !!this.leftPage(a)),
        (d = this.rightPage(a)),
        this.origin.css("left", c && d ? 0 : c ? h / 2 : -h / 2));
      this.positionBookShadow();
      !1 !== b &&
    ...
    holdPage: function (a, b, c, d, e) {
      ...
      if (a) {
        ...
        if (!d) d = this.pageIsOnTheLeft(f) ? "l" : "r";
          ...
          !this.corners[d] ||
          (this.pageIsOnTheLeft(f) ? /r/ : /l/).test(d)
        )
          return;
        ...
        if (e) {
          ...
          if (
            ...
            this.opts.onHoldPage(this, f, a, e);
        }
      }
    },
    ...
    foldPageStart: function (a, b, c, d, e) {
      ...
      if (e && e.length) {
        ...
        f.corner = d;
        f.pageDiagonal = Math.sqrt(h * h + k * k);
        ...
        f.shadowTop = -(f.shadowHeight - k) / 2;
    ...
    foldPageStyles: function (a) {
      ...
      if ("l" == v || "r" == v) {
        ...
        t || ((t = { x: "l" == v ? 0 : b, y: k }), page.data("grabPoint", t));
        v =
          (k >= t.y ? "t" : "b") +
          (this.pageIsOnTheLeft(a.pageIndex) ? "l" : "r");
        a.corner = v;
        a.page.data("holdedCorner", v);
        var q = h - t.x,
          m = k - t.y;
        q = Math.atan2(m, q);
      ...
      q = h - v;
      m = k - r;
      var n = Math.sqrt(q * q + m * m);
      n > b && ((h = v + (b * q) / n), (k = r + (b * m) / n));
      r = c - r;
      q = h - v;
      m = k - r;
      n = Math.sqrt(q * q + m * m);
      var p = a.pageDiagonal;
      n > p && ((h = v + (p * q) / n), (k = r + (p * m) / n));
      v = t[0];
      t = t[1];
      t == k && (k = t + 0.001);
      q = h - v;
      ...
      a.pageContent.css(
        "transform",
        g(-n, 0) + " rotate(" + (-q).toFixed(7) + "deg)"
      );
      a.page.css(
        "transform",
        g((Math.cos(k) * n).toFixed(5), (Math.sin(k) * n).toFixed(5)) +
          " rotate(" +
          q.toFixed(7) +
          "deg)"
      );
      ...
      if (this.shadows && 0 < p) {
        ...
        this.internalShadow.css({
          transform:
            g(n + (a.page.onRight ? a.page.pageWidth : 0), z) +
            " rotate(" +
            q +
            "deg)",
          transformOrigin:
            d - n + "px " + (f + (a.shadowHeight - c) / 2) + "px",
        });
        n -= a.foldShadowWidth;
        this.foldShadow.css({
          transform:
        ...
        this.shadowContainer.css({ opacity: p, display: "block" });
      ...
      n = p.x - h + d - 1;
      c = { x: p.x - h, y: p.y + h * m };
      l = { x: p.x - h, y: p.y - h / (0 == m ? 1e-4 : m) };
      c = w(c, -k);
      l = w(l, -k);
      l = -(l.x + d);
      c = -(c.y - f);
      a.backContent.css("transform", g(-n, 0) + " rotate(" + q + "deg)");
      a.back.css(
        "transform",
        g(
          (v + l + Math.cos(k) * n).toFixed(5),
          (t - c + Math.sin(k) * n).toFixed(5)
        ) +
          " rotate(" +
          q +
          "deg)"
      ...
      this.foldGradient && 0 < p
        ? (this.foldGradientContainer.css({
            ...
            display: "block",
            transform:
              g(b - v - a.foldGradientWidth / 2, t - a.foldGradientHeight / 2) +
              " rotate(" +
              -q +
              "deg)",
          }),
    ...
    flipHardPageStart: function (a, b, c, d, f) {
      ...
      !this.border3D &&
        ...
        this.opts.use3d &&
        Modernizr.csstransforms3d &&
        ((this.border3D = e('<div class="wowbook-3d-border">')),
        this.border3D.css("background", this.opts.pageEdgeColor));
      this.opts.hardPageShadow &&
        !this.hardPageShadow &&
        (this.hardPageShadow = e('<div class="wowbook-hard-page-shadow">'));
      var g = {};
      "number" === typeof a && (a = this.pages[a]);
      g.book = this;
      g.page = a;
      ...
      if (f && f.length) {
        ...
        this.opts.use3d &&
          ...
          f.css(Modernizr.prefixed("perspectiveOrigin"), "0 50%"));
        b = a.onLeft ? h : 0;
    ...
    flipHardPageStyles: function (a) {
      ...
      0 > f && (f = 0);
      f = (l = f < h) ? b : c;
      (l ? c : b).css("display", "none");
      g = g != l;
      a = d - a;
      a > h && (a = h);
      a < -h && (a = -h);
      var m = -Math.sqrt(1600 * (1 - (a * a) / ((h + 15) * (h + 15))));
      l = Math.abs(a / h);
      m = 1 == l ? 0 : Math.atan2(m, a);
      if (this.opts.use3d && Modernizr.csstransforms3d) {
        var t = g
          ? -this._calculateAngleFromX(-a, h)
          : this._calculateAngleFromX(a, h);
        if (this.animating) {
          var q = this._animationData;
          if (this.curledPage || q.curled)
            (q.curled = !0),
              q.angle ||
                ((m = { from: t, to: 0 }),
                (q.angle = m),
                (t = a + q.dx),
                (m.to = g
                  ? -this._calculateAngleFromX(-t, h)
                  : this._calculateAngleFromX(t, h)),
                Math.abs(a) == h && (m.from = 0),
                Math.abs(t) == h && (m.to = 0),
                (m.delta = m.to - m.from)),
              (t = q.angle.from - (q.angle.delta * (q.from.x - d)) / q.dx);
        }
        f.append(this.border3D);
        this.hardPageShadow &&
          (f.append(this.hardPageShadow),
          this.hardPageShadow.css("opacity", 1 - l));
        f.css({
          transform:
            "perspective(" +
        ...
        f.css({
          transform: "skewY(" + m + "rad) scaleX(" + l + ")",
          display: "block",
        });
      !e.wowBook.support.transform &&
        e.wowBook.support.filters &&
        (f.css(
          ...
          "progid:DXImageTransform.Microsoft.Matrix(" +
            ("M11=" + l + ", M12=0, M21=" + Math.tan(m) * l + ", M22=1") +
            ", sizingMethod='auto expand')"
        ),
        f.css({
          marginTop: k - f.height(),
          marginLeft: g ? h - f.width() : 0,
        }));
      this.shadows &&
        this.hardPageDropShadow.css({
          left: g ? (b.onLeft ? b.left : c.left) : h,
          opacity: Math.abs(a) < h / 2 ? 0 : ((Math.abs(a) - h / 2) / h) * 0.8,
        });
    },
    ...
    foldPageBasicStart: function (a, b, c, d, e) {
      ...
      if (e && e.length) {
        ...
        this.foldShadow
          .css({ display: "none", height: h, transform: "", top: a.top })
    ...
    foldPageBasicStyles: function (a) {
      ...
      var k = h / 2;
      if (g) {
        var l = "rect(-1000px " + d + "px " + e + "px " + k + "px)";
        e = "rect(-1000px " + d + "px " + e + "px " + (d - k) + "px)";
        h = b.left + (h - d);
      } else
        (l = "rect(-1000px " + (d - k) + "px " + e + "px -1000px)"),
          (e = "rect(-1000px " + k + "px " + e + "px -1000px)"),
          (h = c.left + (d - h + d));
      b.css("clip", l);
      c.css({ clip: e, left: h, display: "block" });
      l = this.calculateOpacity(2 * k, 2 * d, this.shadowThreshold, 50);
      this.shadows && 0 < l
        ? ((b = g ? b.left + k - a.foldShadowWidth : c.left + d - k + d),
          this.shadowContainer.css("opacity", l),
          this.foldShadow.css({ left: b, display: "block" }))
        : this.foldShadow.css("display", "none");
      l = this.calculateOpacity(2 * k, 2 * d, this.foldGradientThreshold, 50);
      this.foldGradient && 0 < l
        ? ((b = g ? d - k : k - a.foldGradientWidth),
          this.foldGradientContainer.css({
            opacity: l,
            left: b,
            display: "block",
    ...
    gotoPage: function (a, b) {
      ...
      if (!this.animating) {
        ...
        var g = this,
          h = e ? g.leftPage() : g.rightPage();
        if (h) {
          this.uncurl(!0);
          if (e) {
            var k = this.leftPage(a);
            var l = this.rightPage(a);
          } else (k = this.rightPage(a)), (l = this.leftPage(a));
          if (
            this.closable &&
            this.differentPageSizes &&
            h.isCover != l.isCover &&
            ...
            if (0 == h.pageIndex || 0 == l.pageIndex) this.showPage(1, !1);
            else {
              var m = this.pages.length - 1;
              this.otherPage(m) ||
                (h.pageIndex != m && l.pageIndex != m) ||
                this.showPage(this.backPage(m).pageIndex, !1);
            }
            this.gotoPage(l.pageIndex);
          } else {
            var t = l && l.is(":visible");
            if (d)
              for (d = h.pageIndex - 1; 0 <= d; d--)
                this.pages[d].css("display", "none");
            else
              for (d = h.pageIndex + 1, c = this.pages.length; d < c; d++)
                this.pages[d].css("display", "none");
            k &&
              (k.css("display", "block"),
              k.onLeft
            ...
            e
              ? ((t = t || { x: 0, y: 0 }),
                (e = 2 * g.pageWidth),
                (c = "bl" != d ? 0 : h.pageHeight))
              : ((t = t || { x: h.pageWidth, y: 0 }),
                (e = -h.pageWidth),
                (c = "br" != d ? 0 : h.pageHeight));
            var n = "linear";
            if (
              this.centeredWhenClosed &&
              !this._singlePage &&
              (h.isHardPage || l.isHardPage)
            ) {
    ...
    fillToc: function (a, b) {
      ...
      if (0 !== c.length) {
        ...
        for (var g = 0, h = f.length; g < h; g++) {
          var k = f[g];
          k = b
            .replace(/\$\{link\}/g, "#" + this.id + "/" + k.id.substr(1))
            .replace(/\$\{section\}/g, k.title)
            .replace(/\$\{page\}/g, k.page);
    ...
    createToc: function (a) {
      a = this.opts.toc || a || [];
      var b = (this.tocContainer = e(
        "<div class='wowbook-toc' style='display:none'>"
      ).prependTo(e(this.opts.tocParent || "body")));
      b.append(
    ...
    createTocItemList: function (a, b) {
      for (var c = this, d, f, g = 0, h = a.length; g < h; g++) {
        d = a[g];
        f = this.createTocItem(d[0], d[1]).appendTo(b);
        if (d[3])
          f.find("a").on("click", { dest: d[3] }, function (a) {
            a.preventDefault();
        ...
        if (d[2] && d[2].length) {
          ...
          f.addClass("wowbook-collapsed");
          e("<span class='wowbook-toc-item-toggle'></span>").prependTo(f);
          f = e("<ul class='wowbook-toc-items'>").appendTo(f);
          this.createTocItemList(d[2], f);
        }
      }
    },
      ...
      if (this._zoomDataRAF) {
        ...
        if (b) {
          var c = this._zoomOffset,
            d = b.dx - c.dx,
            f = b.dy - c.dy;
          a.offset = { dx: c.dx + 0.2 * d, dy: c.dy + 0.2 * f };
        }
    ...
    _zoom: function (a, b) {
      ...
      k =
        k[0] !== window
          ? k.offset()
          : { left: k.scrollLeft(), top: k.scrollTop() };
      g.css({ width: l, height: m });
      l = k.left - n.left;
      n = k.top - n.top;
      l &&
        ((l += parseFloat(g.css("marginLeft"))),
        g.css("marginLeft", l),
        (h.marginLeft = l));
      n &&
        ((n += parseFloat(g.css("marginTop"))),
        g.css("marginTop", n),
        (h.marginTop = n));
      g = "";
      n = this._zoomOffset.dx / d;
      l = this._zoomOffset.dy / d;
      e.wowBook.support.transform && (n || l)
        ? (g = e.wowBook.utils.translate(n, l))
        : h.css({ left: n, top: l });
      c
        ? ((f /= d),
        ...
        : ((this._cssZoom = f),
          h.css("zoom", f),
          h.css("marginLeft", -h.marginLeft / d),
          h.css("marginTop", -h.marginTop / d));
      e.wowBook.support.transform && h.css("transform", g);
      1 !== this.zoomLevel
        ? this.zoomed ||
          (h.css("marginLeft", -h.marginLeft / d),
          h.css("marginTop", -h.marginTop / d),
          c && h.css("transformOrigin", "0 0"),
    ...
    zoom: function (a, b, c) {
      ...
      if (a !== this.zoomLevel || c.force)
        if ((void 0 == b && (b = this.opts.zoomDuration), 0 == b)) {
          ...
          void 0 == h &&
            (h = this.pageHeight * this.currentScale * this.opts.zoomFocusY);
          var k = { x: f, y: h, offset: { dx: 0, dy: 0 } },
            l = e.extend({ dx: 0, dy: 0 }, this._zoomOffset);
    ...
    zoomTouchSupport: function () {
      if (this.opts.touchEnabled) {
        if (e.browser.ie8mode || e.browser.ie7)
        ...
        f.on("hammer.input", function (b) {
          if (
            ...
            (e(b.target).is("img") &&
              "mousedown" == b.srcEvent.type &&
              b.preventDefault(),
            b.isFinal && a.zoomContent.hasClass("wowbook-dragging"))
          ) {
            c = d = null;
            ...
            var f = a._zoomDataRAF,
              g = f ? f.level : b;
            g < a.zoomMin ||
            (g == a.zoomMin && (a._zoomOffset.dx || a._zoomOffset.dy))
              ? f
                ? (f.callback = function () {
                    a.zoomReset();
                  })
                : a.zoomReset()
              : (a._zoom(b, { force: !0, offset: a._zoomOffset }),
        ...
        f.on("pinchmove pinchstart", function (f) {
          ...
          if (!d) {
            ...
            d = {
              ...
              pageX: g,
              pageY: k,
              x: g - (b.left - e(window).scrollLeft()),
        ...
        this.opts.doubleClickToZoom &&
          (f.get("doubletap").set({ posThreshold: 50 }),
          f.on("doubletap", function (b) {
            b.preventDefault();
            var c = a.elem.offset(),
              d = b.center.x - c.left;
            b = b.center.y - c.top;
    ...
    zoomDragSupportForIE: function () {
      var a = this,
        ...
        d = function (b) {
          b = a.zoomLevel;
          (b < a.zoomMin ||
            (b == a.zoomMin && (a._zoomOffset.dx || a._zoomOffset.dy))) &&
            a.zoomReset();
      ...
      a.zoomContent.bind("mousedown.wowbook", function (f) {
        if (a.zoomed)
          return (
            ...
            e(document).bind("mousemove.wowbook", c).bind("mouseup.wowbook", d),
            !1
          );
      });
    },
    ...
    setupFullscreen: function () {
      if (C) {
        ...
        this._fullscreenChangeHandler = function () {
          var b = !!F();
          e(a.opts.fullscreenElement).toggleClass(
        ...
        this._fullscreenErrorHandler = function () {
          ...
          a.opts.onFullscreenError &&
            (b = a.opts.onFullscreenError.apply(this, arguments));
          !1 !== b &&
            ("string" == typeof b
              ? alert(b)
    ...
    toggleFullscreen: function () {
      F() ? this.exitFullscreen() : this.enterFullscreen();
    },
      ...
      e(document).on("touchend.wowbook touchcancel.wowbook", function (b) {
        if (a._touchStarted) {
          ...
          if (!a.zoomed) {
            ...
            var d = c.x - b.x,
              f = c.timestamp - b.timestamp;
            if (
              !(20 > Math.abs(d) || f > a.opts.swipeDuration) &&
    ...
    pageEdgeDragStart: function (a) {
      if (!this.zoomed) {
        if (
          ...
          !e(a.target).hasClass("wowbook-handle")
        )
          return !1;
        var b = this,
          c = b.origin.offset();
        ...
        e(document)
          .bind("mousemove.wowbook", function (a) {
    ...
    initThumbnails: function () {
      var a = this.opts;
      this.thumbnails = [];
      var b = (this.thumbnailsContainer = e("<div class='wowbook-thumbnails'>")
        .append(
          "<div class='wowbook-wrapper'><a class='wowbook-back wowbook-button wowbook-control wowbook-control-back'/><div class='wowbook-clipper'><ul></ul></div><a class='wowbook-next wowbook-button wowbook-control wowbook-control-next' /></div>"
        )
        .css("display", "none")
        .css("transform", "translateZ(0)")
        .appendTo(e(a.thumbnailsParent)));
    ...
    scrollBarWidth: function () {
      var a = e(
          "<div style='display: inline-block;position: absolute;left:-1000px;'>Hi!</div>"
        ).appendTo("body"),
        b = a.width();
    ...
    thumbnailConfig: function () {
      ...
      e.wowBook.support.transform
        ? (a.cloneCSS.transform = "scale(" + f + ")")
        : (a.cloneCSS.zoom = f);
      this.differentPageSizes &&
        ((b = this.opts.pageWidth
          ? (f * this.pageWidth) / this.opts.pageWidth
          : this.opts.pageHeight
          ? (f * this.pageHeight) / this.opts.pageHeight
    ...
    createThumbnail: function (a, b) {
      ...
      if (c) {
        ...
        var d = e('<li class="wowbook-thumbnail"><div class="wowbook-overlay">')
            .addClass(
              this.pageIsOnTheLeft(a) ? "wowbook-left" : "wowbook-right"
            )
            .css({ width: b.width, height: b.height }),
          f = c.find(".wowbook-page-content");
        (f = f.data("thumb") || f.data("thumbnail"))
          ? (d.addClass("wowbook-thumbnail-custom"), (d.src = f))
          ...
          : ((f = c.clone()),
            f.hasClass("wowbook-page-holded") &&
              (this.resetPage(f),
              f.find(".wowbook-fold-gradient-container").remove()),
            f.css(b.cloneCSS),
    ...
    toggleThumbnails: function (a) {
      e(this.thumbnailsContainer).is(":visible")
    ...
    pdfRenderPage: function (a, b, c, d, f) {
      if (this.pdfPageRendering) this.pdfQueueRenderPage(a, b, c, d, f);
        ...
        this.pdfDoc.getPage(a + 1).then(function (h) {
          ...
          var k = h.getViewport(d * g.pdfCSS_UNITS * g.opts.pdfScale),
            l = g.pages[a],
            m = !1,
            n = !1;
          if (g.opts.pdfUpdateRender && "thumb" != f) {
            var q = g.currentScale * g.zoomLevel * g.opts.pdfPixelRatio;
            k = l.pageWidth * q;
            g.opts.pdfRoundWidth && 0.5 <= k % 1 && (k = Math.round(k));
            var r = h.getViewport(1);
            k = h.getViewport(k / r.width);
            b
              ? e(b)
                  .addClass("wowbook-pdf-zoom-" + q)
                  .css({
                    transform: "scale(" + 1 / q + ")",
                    "transform-origin": "0 0 0",
                  })
              : ((b = l.find(".wowbook-pdf-zoom-" + q)),
                (n = b.length),
                b.length ||
                  ((b = e("<canvas>").addClass("wowbook-pdf-zoom-" + q)),
                  b.css({
                    transform: "scale(" + 1 / q + ")",
                    "transform-origin": "0 0 0",
                  }),
          ...
          n ||
            ((b.height = Math.ceil(k.height)), (b.width = Math.ceil(k.width)));
          q = { canvasContext: b.getContext("2d"), viewport: k };
          k = function () {
            m &&
              !e(b).parent().length &&
              e(b).appendTo(l.find(".wowbook-page-content"));
            c && c.call(g, g.pages[a], b);
            if ("thumb" != f) {
              l.find("canvas").not(b).remove();
              var d = h.getViewport(1 * g.pdfCSS_UNITS * g.opts.pdfScale);
              d = h.getViewport(
                (g.pdfWidth / d.width) * g.pdfCSS_UNITS * g.opts.pdfScale
              );
              if (!l.find(".wowbook-pdf-annotations").length) {
                var k = e('<div class="wowbook-pdf-annotations">').appendTo(
                  l.find(".wowbook-page-content")
                );
                g.pdfAnnotations(h, d, k);
              }
              g.opts.pdfTextSelectable &&
                !l.textLayer &&
                "thumb" != f &&
                g.pdfTextLayer(h, a, d);
            }
            g.pdfPageRendering = !1;
            g.pdfDequeueRenderPage();
          };
          n ? k() : h.render(q).then(k, function () {});
        });
      }
    },
    ...
    pdfTextLayer: function (a, b, c, d) {
      if (!d) {
        var f = this.pages[b];
        d = f.find(".wowbook-pdf-text");
        d.length ||
          (d = e('<div class="wowbook-pdf-text">').appendTo(
            f.find(".wowbook-page-content")
          ));
      }
    ...
    pdfNavigateTo: function (a) {
      ...
      var c = function (a) {
        var d =
          a instanceof Object
            ? b.pagesRefMap[a.num + " " + a.gen + " R"]
            : a + 1;
        d
          ? b.gotoPage(d - 1)
          : b.pdfDoc.getPageIndex(a).then(function (d) {
    ...
    pdfRenderThumbnail: function (a, b, c) {
      ...
      if ((c = this.pages[a]) && !c.loading && !b.pdf && !b.rendering) {
        ...
        var d = b.find("canvas");
        d.length ||
          (d = e("<canvas>").appendTo(b.find(".wowbook-page-content")));
        d.css("transform", "");
    ...
    createFindControl: function (a, b) {
      ...
      e(a)
        ...
        .on("click.wowbook", function (a) {
          if (!e(a.target).closest(".wowbook-findbar").length)
    ...
    createFindBar: function () {
      ...
      ).appendTo(e(this.toolbars[0]).find(".wowbook-controls"));
      this._pdfFindBar = a;
    ...
    createContainer: function (a) {
      ...
      this.containerBook = e("<div class='wowbook-book-container'>")
        .appendTo(a)
        .append(this.elem);
      this.containerToolbar = e(
    ...
    updateContainer: function () {
      ...
      a.toolbarParent == this.containerToolbar &&
        ...
        (b = e(this.toolbars[0]).outerHeight(!0)));
    ...
    lightbox: function (a) {
      ...
      e("<button class='wowbook-close'>\u2715</button>")
        .appendTo(this._lightboxElem)
    ...
    showLightbox: function () {
      ...
      e.wowBook.utils.isIOS && e("html").addClass("wowbook-lightbox-ios");
    ...
    centerLightbox: function () {
      ...
      this.opts.toolbarParent == this._lightboxElem &&
        (this.opts.responsiveToolbar && this.updateResponsiveToolbar(),
        (a = e(this.toolbars[0]).outerHeight(!0)),
    ...
    generateCSSClassName: function () {
      e.wowBook.utils._cssClassCounter =
        (e.wowBook.utils._cssClassCounter || 0) + 1;
    ...
    controllify: function (a) {
      ...
      e(a.lastLeft || a.lastleft).on("click.wowbook", function () {
        b.gotoLastLeft();
        return !1;
      });
      ...
      var c =
        this.opts.downloadURL ||
        this.opts.downloadurl ||
        this.opts.downloadUrl ||
        this.opts.pdf;
      c && e(a.download).attr("href", c).attr("download", c);
      (c = this.opts.homeURL || this.opts.homeurl || this.opts.homeUrl) &&
        e(a.home).attr("href", c);
      e(a.share).length && this.createShareControl(e(a.share));
      a.currentPage && this.createCurrentPageControl(a.currentPage);
      c =
        "zoomIn zoomOut zoomReset left lastLeft right lastRight next back first last slideShow flipSound thumbnails fullscreen toc currentPage download find".split(
          " "
        );
      for (var d, f = 0, g = c.length; f < g; f++)
        (d = c[f].toLowerCase()),
          (this._controls[d] = e(this._controls[d]).add(a[c[f]] || a[d]));
      this.setStrings();
    },
    toggleControl: function (a, b) {
      (a = this._controls[a.toLowerCase()]) &&
        e(a).toggleClass("wowbook-disabled", b);
    },
    ...
    createShareControl: function (a, b) {
      b || (b = this.opts);
      for (
        var c = e.extend({}, this.shareControlButtons, b.shareButtons),
          d,
          f = b.share.split(/\s*,\s*|\s+/),
          g = e("<div class='wowbook-share-buttons wowbook-hidden'>"),
          h = 0,
          k = f.length;
        h < k;
        h++
        ...
        (d = c[f[h]]) &&
          e(d[0])
            ...
            .data("params", d[1]);
      c = e(a).addClass("wowbook-control-share").append(g);
      var l = this;
      ...
      c.on("click", ".wowbook-share-button", function () {
        ...
        if (!e.isFunction(a) || !1 !== a(l, this)) {
          a = e.extend({}, e(this).data("params"));
          var b = e.extend(e.wowBook.defaults.shareParams, l.opts.shareParams);
    ...
    createCurrentPageControl: function (a) {
      ...
      if (a.length) {
        ...
        c.on("keypress.wowbook", function (a) {
          var b = "8,9,13,35,36,37,39".match(new RegExp(a.which));
          !a.which ||
            (49 <= a.which && 57 >= a.which) ||
            (48 == a.which && e(this).val()) ||
            b ||
            a.preventDefault();
        });
    ...
    createToolbar: function (a, b) {
      if (
        a &&
        (b = e(b || this.opts.toolbarParent || this.elem.parent())) &&
        b.length
      ) {
        ...
        a = a.split(/\s*,\s*/);
        for (var f = {}, g, h = 0; h < a.length; h += 1)
          (g = this.createToolbarControl(a[h])), (f[a[h]] = g), d.append(g);
        this.opts.removeStickyHoverStyle &&
          ...
          c.on("touchend", ".wowbook-control", function () {
            e(".remove-sticky-hover-style").removeClass(
    ...
    createResponsiveToolbarToggle: function () {
      this.responsiveToolbarToggle = e(
        "<a class='wowbook-control wowbook-control-toggle-toolbar'><i></i></a>"
    ...
    translate: function (a, b, c, d) {
      e.wowBook.support.transform && !1 !== d
        ? a.css(
            "transform",
            e.wowBook.useTranslate3d
  ...
  e.wowBook.defaults = {
    ...
    flipSoundPath: "./assets/lib/wow_book/wow_book/sound/",
  ...
  e.wowBook.wowBookConstructor = p;
  window.raf = (function () {
    return (
  ...
  var m = e.browser.msie && 9 > e.browser.version ? 1 : 0,
    z = { thin: 2 - m, medium: 4 - m, thick: 6 - m },
    n = window.document,
    B = n.documentElement,
    C =
      B.requestFullscreen ||
    ...
    F = function () {
      return (
        ...
        n.webkitCurrentFullScreenElement
      );
    };
  e.wowBook.utils = {
    translate: function (a, b, c) {
      return e.wowBook.useTranslate3d
...
(function (e) {
  function p(r) {
    ...
    var w = n;
    void 0 !== m.axis &&
      m.axis === m.HORIZONTAL_AXIS &&
      ((w = 0), (u = -1 * n));
    void 0 !== m.wheelDeltaY && (w = m.wheelDeltaY / 120);
    void 0 !== m.wheelDeltaX && (u = (-1 * m.wheelDeltaX) / 120);
    p.unshift(r, n, u, w);
    return (e.event.dispatch || e.event.handle).apply(this, p);
  }
  var w = ["DOMMouseScroll", "mousewheel"];
  if (e.event.fixHooks)
    for (var u = w.length; u; ) e.event.fixHooks[w[--u]] = e.event.mouseHooks;
  e.event.special.mousewheel = {
    setup: function () {
      if (this.addEventListener)
        for (var e = w.length; e; ) this.addEventListener(w[--e], p, !1);
      else this.onmousewheel = p;
    },
    teardown: function () {
      if (this.removeEventListener)
        for (var e = w.length; e; ) this.removeEventListener(w[--e], p, !1);
...
(function (e) {
  function p(p) {
    if (p in w.style) return (e.wowBook.support[p] = p);
    for (
      var m = u.length, r, n = p.charAt(0).toUpperCase() + p.substr(1);
      m--;

    )
      if (((r = u[m] + n), r in w.style)) return (e.wowBook.support[p] = r);
  }
  if (e.cssHooks) {
    ...
    e.wowBook.support.boxSizing &&
      ...
      (e.wowBook.support.boxSizing = !1);
    w = null;
    e.each(["transform", "transformOrigin"], function (p, m) {
      e.wowBook.support[m] &&
        e.wowBook.support[m] !== m &&
        !e.cssHooks[m] &&
        (e.cssHooks[m] = {
          get: function (p, n, r) {
            return e.css(p, e.wowBook.support[m]);
          },
          set: function (p, n) {
            p.style[e.wowBook.support[m]] = n;
          },
        });
    });
    e.wowBook.applyAlphaImageLoader = function (p) {
      var m,
        r,
        n = "",
        u = e("<div style='display:none'></div>").appendTo("body");
      var w = 0;
      for (r = p.length; w < r; w++) {
        var D = p[w];
        u.addClass(D);
        if ((m = u.css("background-image").match(/^url\("(.*)"\)$/)))
          (n +=
            "." +
            D +
