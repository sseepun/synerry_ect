...
<body class="loading">
  ...
  <div id="main" class="main-container">
    ...
    <div id="mainContent" class="main-content">
      ...
      <div class="wrapper">
        <div class="ss-box m-unset style-02 w-full-sm all-bradius xxl size-04" data-aos="fade-in" data-aos-delay="150">
                ...
                <fieldset class="mt-2">
                  ...
                  <div class="grids">
                    <div class="grid lg-50 md-100 sm-100 mt-3">
                      <label class="form-check form-check-container size-02" id="check_01">
                    ...
                    <div class="grid xl-100 lg-100 md-100 sm-100">
                      <div class="btns mt-2 jc-center pl-unset-xs h-full">
                        <button type="submit" href="#" class="btn btn-popup-toggle btn-action btn-02" data-popup="99">
                          บันทึก
                        </button>
                        <button type="cancel" href="#" class="btn btn-action btn-05">
                          ยกเลิก
                        </button>
                      </div>
                    </div>
