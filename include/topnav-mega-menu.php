...
<!-- Topnav -->
<nav class="topnav mega-menu-01 style-02 <?= !empty($optionMenu)? $optionMenu: '' ?>">
  <div class="wrapper">
    <a class="logo" href="#">
                ...
                <div class="mega-menu-dropdown">
                  <div class="mega-menu-wrapper">
                    ...
                    <div class="mega-menu-content size-03">
                      <div class="mega-menu">
                        <div class="icon">
                          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 372.3 332.2">
                            <g>
                              <path class="st0" d="M267.9,271c0-79,0-158.7,0-239c-1.1,1-1.7,1.5-2.3,2.1C237,61.1,203.1,75.1,163.8,75.7
                                ...
                                c0,35.1,0,70.3,0,105.5c23.5-6.5,39.7-31.2,38-57.8C370.8,125.6,351.5,101.3,334.2,99z"></path>
                              <path d="M267.9,271c-9.9-7.2-19.5-15.2-30.1-21.7c-22.9-14-48-20.6-74.8-20.6c-14,0-28,0-42,0c-1.4,0-2.7,0-4.3,0
                                ...
                                C267.9,112.3,267.9,192,267.9,271z"></path>
                              <path d="M104.5,75c0,51.5,0,101.9,0,152.3c-0.2,0.2-0.4,0.5-0.5,0.5c-17.9-0.3-35.9,2.1-53.4-4.2c-32.4-11.7-53.2-44-50.3-78.7
                                C3.1,111.7,29,82.6,62.2,77.4C76,75.2,90.2,75.7,104.5,75z"></path>
                              <path d="M279.9,151.5c0-47.6,0-95.2,0-142.8c0-7,1.6-8.6,8.5-8.6c8.4,0,16.7,0,25.1,0c7,0,8.8,1.9,8.8,9c0,15.5,0,31,0,46.5
                                ...
                                c-0.1-1.2,0-2.5,0-3.7C279.9,246.2,279.9,198.8,279.9,151.5z"></path>
                              <path d="M143.4,240c0.1,1.3,0.2,2.4,0.2,3.5c0,18.6,0.1,37.2,0,55.9c-0.1,18.9-14.3,33.1-32.6,32.9c-16.4-0.2-30.6-13.1-31.1-29.5
                                c-0.6-20.6-0.2-41.2-0.1-61.8c0-0.2,0.2-0.4,0.4-0.8C101.1,240,122.2,240,143.4,240z"></path>
                              <path d="M334.2,99c17.3,2.3,36.6,26.6,38,47.7c1.7,26.6-14.4,51.3-38,57.8C334.2,169.3,334.2,134.1,334.2,99z"></path>
                            </g>
                          </svg>
                        </div>
                      ...
                      <div class="mega-menu ">
                        <div class="icon xs">
                          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 384 155.9">
                            <g>
                              <path d="M0,72c2.2-6,3.5-12.6,6.8-18c10.7-17.7,27-25.8,47.5-23c19.5,2.7,32.4,14.3,38.8,33c0.3,0.8,0.6,1.6,0.9,2.6
                                ...
                                c13.6-14.6,26.9-28.9,40.4-43.3C334.3,61.3,329,56.4,323.3,51.1z"></path>
                            </g>
                          </svg>
                        </div>
                      ...
                      <div class="mega-menu">
                        <div class="icon">
                          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 316.1 384" style="enable-background:new 0 0 316.1 384;" xml:space="preserve">
                            <g>
                    ...
                    <div class="mega-menu-content size-04">
                      <div class="mega-menu">
                        <div class="icon">
                          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 384 384">
                            <g>
                              <path d="M203.3,0c7.2,1,14.3,1.7,21.4,3c32.9,5.9,62.2,19.7,88,40.9c2.6,2.2,4.9,3.3,8.6,2.6c17.6-3.6,35.5,8.7,38.8,26.4
                                ...
                                C3.8,138.4,17.2,104,41.1,73.8c30.6-38.5,70.1-62.4,118.6-71c6.7-1.2,13.5-1.9,20.3-2.9C187.8,0,195.5,0,203.3,0z"></path>
                      ...
                      <div class="mega-menu">
                        <div class="icon">
                          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 319.9 319.9">
                            <g>
                              <path fill="none" d="M256,96c0-1.8,0-3.2,0-4.6c0-19.4,0-38.7,0-58.1c0-19.6-13.6-33.3-33.2-33.3C159.5,0,96.3,0,33,0.1
                                ...
                                C281.3,96,268.9,96,256,96z"></path>
                              <path d="M256,96c12.9,0,25.3,0,37.7,0c4,0,8-0.1,12,0.1c7.4,0.5,13.5,6.7,14.2,14.1c0.1,1.1,0.1,2.2,0.1,3.4
                                ...
                                c-0.3-8.8-7.3-15.4-16.5-15.4C111.7,63.9,104,64,96.3,64z"></path>
                            </g>
                          </svg>
                        </div>
