...
<!-- Footer -->
<nav class="footer style-06 p-0">
  <div class="container">
    <div class="grids">
      <div class="grid xl-40 lg-50 md-50 sm-100">
        <div class="grids">
          <div class="grid xl-60 lg-100 sm-100 mt-0 mb-6">
            <h6 class="color-04 fw-500 mb-2">สำนักงานคณะกรรมการการเลือกตั้ง</h6>
            <p class="sm fw-500">
          ...
          <div class="grid xl-40 lg-100 sm-100 mt-0">
            <h6 class="color-04 fw-500 mb-2">ติดต่อ</h6>
            <div class="list-icon mt-3">
              <div class="icon color-04"><em class="fa-solid fa-phone"></em></div>
              <p class="color-04 sm fw-500">+66 0-2141-8888</p>
            </div>
            <div class="list-icon mt-2">
              <div class="icon color-04"><em class="fa-solid fa-fax"></em></div>
              <p class="sm color-04 fw-500">+66 0-2143-8510</p>
            </div>
            <div class="list-icon mt-2">
              <div class="icon color-04"><em class="fa-solid fa-envelope"></em></div>
              <p class="sm color-04 fw-500">webmaster@ect.go.th</p>
            </div>
            <h6 class="fw-400 mb-2 mt-3 color-04">ติดตาม กกต.</h6>
      ...
      <div class="grid xl-60 lg-50 md-50 sm-100 mt-0">
        <div class="grids">
          <div class="grid xl-30 lg-50">
            <h6 class="color-04 fw-500 mb-1">แผนผังเว็บไซต์</h6>
            <ul class="ss-list style-07">
              <li class="sm"><a href="#" class="xl-no-br">สถาบันพัฒนาการเมืองและ<br/>การเลือกตั้ง</a></li>
              ...
              <li class="sm"><a href="#" class="xl-no-br">หนังสือเวียนอิเล็กทรอนิกส์<br/>(ส่วนกลาง)</a></li>
            </ul>
          </div>
          ...
          <div class="grid xl-40 lg-100 md-100 sm-100">
            <h6 class="color-04 fw-500 mb-2">แผนที่</h6>
             <!-- Goolgle Map -->
             <iframe 
    ...
    <div class="container">
      <div class="grids jc-center">
        <div class="grid lg-1-3 sm-100 mt-0">
          <div class="counts">
            <p class="sm fw-400">จำนวนผู้เข้าชมเว็บไซต์</p>
        ...
        <div class="grid lg-1-3 sm-100 mt-0">
          <p class="sm fw-500">สงวนลิขสิทธิ์ 2559 - สำนักงานคณะกรรมการการเลือกตั้ง</p>
        </div>
        <div class="grid lg-1-3 sm-100 mt-0">
          <a class="p sm h-color-07 fw-500 border-bottom bcolor-white" href="#">
