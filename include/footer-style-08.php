...
<!-- Footer -->
<nav class="footer style-09 theme-02 p-0">
  <div class="container">
    <div class="grids">
      <div class="grid xl-30 lg-40 sm-100">
        <h6 class="color-white fw-500 mb-2">
          สำนักงานคณะกรรมการการเลือกตั้ง<br>
          ประจำจังหวัดกำแพงเพชร
        </h6>
        <p class="sm color-white fw-300">
          เลขที่ 167 ถนนเทศา 2 ตำบลในเมืองอำเภอ เมืองกำแพงเพชร<br />
          จังหวัดกำแพงเพชร 62000
        </p>
        <div class="list-icon color-white mt-3">
          <div class="icon"><em class="fa-solid fa-phone"></em></div>
          <p class="sm fw-300">โทร. +66 0-2141-8888</p>
        </div>
        <div class="list-icon color-white mt-2">
          <div class="icon"><em class="fa-solid fa-envelope"></em></div>
          <p class="sm fw-300">Email : webmaster@ect.go.th</p>
        </div>
        <h6 class="fw-400 color-white mb-2 mt-3">ติดตาม กลต.</h6>
      ...
      <div class="grid xl-70 lg-60 sm-100 mt-0">
        <div class="grids">
          <div class="grid xl-30 lg-50">
            <h6 class="color-white fw-500 mb-1">แผนผังเว็บไซต์</h6>
            <ul class="ss-list style-11">
          ...
          <div class="grid xl-40 lg-100 md-100 sm-100">
            <h6 class="color-white fw-500 mb-2">แผนที่</h6>
            <!-- Goolgle Map -->
    ...
    <div class="container">
      <div class="grids jc-center">
        <div class="grid xl-40 lg-100 sm-100 mt-0">
          <div class="count-container style-02">
            <div class="counts">
        ...
        <div class="grid xl-60 lg-100 sm-100 mt-0">
          <div class="grids h-full">
            <div class="grid lg-60 sm-100 mt-0">
              <p class="sm copyright fw-500 d-flex ai-center h-full">
                &copy สงวนลิขสิทธิ์ 2565 - สำนักงานคณะกรรมการการเลือกตั้ง
              </p>
            </div>
            <div class="grid lg-40 sm-100 mt-0">
              <p class="xs policy d-flex ai-center h-full">
                <a class="h-color-sgray color-white fw-500 border-bottom bcolor-white" href="#">
