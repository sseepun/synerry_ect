...
<!-- Super Topnav -->
<nav class="stopnav style-04 bg-white bcolor-sgray">
  <div class="wrapper">
    <div class="blocks blocks-main">
      ...
      <div class="blocks">
        ...
        <a class="option color-04 bcolor-sgray" href="#">
          ...
          <p class="sm color-gray fw-400">webmaster@ect.go.th</p>
        </a>
        <div class="blocks hide-tablet">
          <div class="option bcolor-sgray">
  ...
  <div class="wrapper">
    ...
    <div class="blocks">
      <a class="option global-search-toggle pb-1" href="#">
        <img src="public/assets/app/images/icon/search-03.png" alt="Icon" />
      </a>
