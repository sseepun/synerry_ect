...
<!-- Footer -->
<nav class="footer style-05 p-0">
  <div class="container">
    <div class="grids">
      <div class="grid xl-50 lg-100 sm-100">
        <div class="grids">
          <div class="grid xl-50 lg-2-3 sm-100 mt-0 mb-6">
            <h6 class="fw-500 mb-2">สำนักงานคณะกรรมการการเลือกตั้ง</h6>
            <p class="sm fw-500">
              เลขที่ 120 ม.3 ชั้น 2 อาคารรัฐประศาสนภักดี
            ...
            <div class="list-icon mt-3">
              ...
              <p class="sm fw-500">+66 0-2141-8888</p>
            </div>
            <div class="list-icon mt-2">
              <div class="icon"><em class="fa-solid fa-fax"></em></div>
              <p class="sm fw-500">+66 0-2143-8510</p>
            </div>
            <div class="list-icon mt-2">
              <div class="icon"><em class="fa-solid fa-envelope"></em></div>
              <p class="sm fw-500">webmaster@ect.go.th</p>
            </div>
            <h6 class="fw-400 mb-2 mt-3">ติดตาม กกต.</h6>
          ...
          <div class="grid xl-50 lg-100 md-100 sm-100 mt-0">
            <h6 class="fw-500 mb-2">แผนที่</h6>
             <!-- Goolgle Map -->
      ...
      <div class="grid xl-50 lg-100 sm-100 mt-0">
        <div class="grids">
          <div class="grid xl-1-3 lg-1-3">
            <h6 class="fw-500 mb-2">แผนผังเว็บไซต์</h6>
            <ul class="ss-list style-06">
              <li class="sm"><a href="#" class="lg-no-br">สถาบันพัฒนาการเมือง<br>และการเลือกตั้ง</a></li>
          ...
          <div class="grid xl-1-3 lg-1-3 mute-xs">
            <h6 class="fw-400 title-empty mb-2">แผนผังเว็บไซต์</h6>
            <ul class="ss-list style-06">
              <li class="sm"><a href="#">ทำเนียบผู้บริหาร</a></li>
              <li class="sm"><a href="#">บริการ E-mail ภาครัฐ</a></li>
              <li class="sm"><a href="#" class="lg-no-br">หนังสือเวียนอิเล็กทรอนิกส์<br>(ส่วนกลาง)</a></li>
              <li class="sm"><a href="#" class="lg-no-br">โครงการพัฒนาศูนย์กลาง<br>ความรู้แห่งชาติ</a></li>
          ...
          <div class="grid xl-1-3 lg-1-3 mute-xs">
            ...
            <ul class="ss-list style-06">
              ...
              <li class="sm"><a href="#" class="lg-no-br">รายงานผลการปฏิบัติงาน<br>ประจำปี</a></li>
    ...
    <div class="container">
      <div class="grids jc-center">
        <div class="grid lg-1-3 sm-100 mt-0">
          <div class="counts">
            <p class="sm color-05 fw-400">จำนวนผู้เข้าชมเว็บไซต์</p>
        ...
        <div class="grid lg-1-3 sm-100 mt-0">
          <p class="sm color-05 fw-500">สงวนลิขสิทธิ์ 2559 - สำนักงานคณะกรรมการการเลือกตั้ง</p>
        </div>
        <div class="grid lg-1-3 sm-100 mt-0">
          <a class="p sm h-color-04 color-02 fw-500 border-bottom bcolor-02" href="#">
