...
<nav class="footer style-04 p-0">
  ...
  <div class="container">
    <div class="grids">
      <div class="grid xl-30 lg-40 sm-100">
        ...
        <div class="counts">
          <p class="color-04 fw-400">จำนวนผู้เข้าชมเว็บไซต์</p>
          <div class="count-web">
            <div>8</div>
            <div>8</div>
            <div>8</div>
  ...
  <div class="footer-bottom">
    <div class="container">
      <p class="xs">
        <span class="color-05 fw-500 mr-3">สงวนลิขสิทธิ์ 2559 - สำนักงานคณะกรรมการการเลือกตั้ง</span>
        <span class="mr-3">|</span>
        <a class="h-color-04 color-02 fw-500 border-bottom bcolor-02" href="#">
