                    ...
                    <div class="grids jc-center flex-column-reverse sm">
                      <div class="grid lg-50 md-50 sm-100 xs-100 mt-0">
                        ...
                        <fieldset>
                          ...
                          <div class="btns mt-4">
                            <button id="btnVote" type="submit" class="btn btn-action btn-36 poll theme-bg-02 black-theme btn-popup-toggle" data-popup="99">
                              โหวต
                            </button>
                          </div>
                        </form>
                      ...
                      <div class="grids jc-center flex-column-reverse sm">
                        <div class="grid lg-50 md-50 sm-100 xs-100 mt-0">
                          <form action="action.php" method="post">
                            ...
                            <div class="btns mt-4">
                              <button class="btn btn-action btn-36 theme-bg-02 poll black-theme btn-popup-toggle" data-popup="99">
                                โหวต
                              </button>
                            </div>
                          </form>
