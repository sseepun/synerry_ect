...
<body class="loading">
  ...
  ?>
  <section class="section-padding pt-0 section-18 tab-container bg-10">
    <div class="container">
      <div class="ss-box bg-10 w-full">
        ...
        <div class="grids no-gap mt-6 pt-5">
  ...
  <section class="section-19">
    ...
    <div class="container h-full">
      <div class="wrapper h-full">
        ...
        <div class="image-container">
          <img src="public/assets/app/images/content/06.png" alt="Image">      
        </div>   
      </div>       
    </div>     
  </section>
