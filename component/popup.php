<div class="popup-container style-02" data-popup="98">
  <div class="wrapper">
    <div class="close-filter btn-popup-toggle" data-popup="98"></div>
    <div class="popup-box">
      ...
      <div class="box-body text-center">
        <?php if(in_array('fg-password', $listResult)) {?>
          ...
          <p>ระบบได้ดำเนินการส่งรหัสผ่านของคุณ<br>เรียบร้อยแล้ว</p>
          <div class="btns mt-4">
