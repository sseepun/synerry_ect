  ...
  <div class="wrapper">
    ...
    <div class="container">
      <form action="./" method="GET">
        <h2 class="h4 fw-500 text-center color-black mb-4">
          พิมคำค้นหา
        </h2>
        ...
        <div class="popular-search-container home-page transparent-theme  popular-tags d-flex fw-wrap ai-center jc-center pl-0">
          <p class="color-black fw-400 mr-2">แท็กยอดนิยม</p>
          <div class="ss-tags style-03 background-01">
            <div class="tag">
...
<nav class="side-panel <?= !empty($sidePanelStyle)? $sidePanelStyle: '' ?> access-panel">
  <div class="wrapper">
      ...
      <div class="panel-row">
        ...
        <div class="options">
          ...
          <div class="option-row theme-btn cursor-pointer theme-btn-6" data-theme="5">
            ...
            <p><span class="fw-400">สีปกติ 4</span></p>
          </div>
    ...
    <svg class="icon-inactive" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 400 400">
            <path class="st0" d="M193.2,79.7c-9.1,2.5-16.5,10-19,19.2c-0.9,3.3-0.9,9.9,0,13.2c2.5,9.3,9.9,16.7,19.2,19.2
              c3.3,0.9,9.9,0.9,13.2,0c9.3-2.5,16.7-9.9,19.2-19.2c0.4-1.4,0.7-4.4,0.7-6.6c0-2.2-0.3-5.2-0.7-6.6c-2.5-9.3-9.9-16.7-19.2-19.2
              C203.4,78.8,196.3,78.9,193.2,79.7 M109.7,132.7c-2.4,1-4.6,3.4-6.3,6.6c-1.2,2.3-1.5,3.6-1.7,6.7c-0.3,4.6,0.3,6.4,2.6,9.1
