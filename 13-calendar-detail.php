                ...
                <div class="title-footer mt-2">
                  <div class="wrapper">
                    <div class="item">
                      <div class="icon">
                        ...
                        <span class="p sm ml-1 fw-500">เรื่องเด่น กกต.</span>
                      </div>
                    </div>
                    <div class="item">
                      <div class="icon">
                        <em class="fa-solid fa-clock"></em>
                        <span class="p sm ml-1 fw-500">12:50 - 13:50</span>
                      </div>
                    </div>
                    <div class="item">
                      <div class="icon">
                  ...
                  <div class="wrapper">
                    <div class="icon">
                      ...
                      <span class="p sm ml-1 fw-500">ณ ห้องประชุมพุงช้าง วิทยาลัยเทคนิคพังงา2 อำเภอเมืองพังงา</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="tags-container" data-aos="fade-up" data-aos-delay="150">
            <div>
              ...
              <div class="ss-tags d-inline-block">
                <div class="tag style-02 fw-400">ข่าวประกาศ</div>
             </div>
             <div class="ss-tags d-inline-block">
                <div class="tag style-02 fw-400">อบรมหลักสูตร</div>
             </div>
             <div class="ss-tags d-inline-block">
                <div class="tag style-02 fw-400">การเลือกตั้ง</div>
             </div>
            </div> 
